    ...
    <section id="features" className="relative py-28">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="mt-2 max-w-md text-muted">
                Drag triggers and actions onto a canvas. Branch on conditions,
                add approvals, and watch runs execute in real time — no code.
              </p>
          ...
          <Card icon={Plug} title="300+ integrations" desc="Slack, Notion, HubSpot, Stripe, Sheets — connect in a click." />
          <Card icon={ShieldCheck} title="SOC 2 secure" desc="Encryption at rest, granular roles, full audit logs." />
          <Card icon={GitBranch} title="Conditional logic" desc="Branch, loop and wait on real-world events." />
          <Card icon={Clock} title="Scheduled runs" desc="Cron-style triggers down to the minute, any timezone." />
        </div>
      </div>
    </section>
  )
